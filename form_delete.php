        ...
        <div class="user-header-inner">
            ...
            <div class="uh-right">
                <div class="user-info">
                    ...
                    <button class="btn">Chỉnh Sửa Trang Cá Nhân</button>
    ...
    <div class="user-page-wrapper">
        <div class="user-page-inner">
            ...
            <div id="img1" class="image-wrapper">
                    ...
                    <img class="image" src="<?php echo $bai_viet['png'] ?>" alt="">
                
            
                <div id="iov1" class="img-overlay-wrapper">
                    <div class="img-btns">                        <p>465 <i class="uil uil-heart-alt"></i> <i class="uil uil-comment"></i></p>
                    </div>
                    <div class="img-overlay">
                        <a class="img-overlay" href="delete.php?ID_bai_viet=<?php echo $bai_viet['ID_bai_viet'] ?>">
